...
public class PersonajeServiceImpl implements PersonajeService {
	...
	public Personaje savePersonaje(PersonajeDto p) {
		...
		nuevoPersonaje.addPeliculaSerie(peliculaRepository.getById(p.getIdPeliculaSerie()));
	...
	public Personaje updatePersonaje(Integer id,PersonajeDto p) {
		...
		if(p.getIdPeliculaSerie() != null) 
			personajeUpdate.addPeliculaSerie(peliculaRepository.getById(p.getIdPeliculaSerie()));
