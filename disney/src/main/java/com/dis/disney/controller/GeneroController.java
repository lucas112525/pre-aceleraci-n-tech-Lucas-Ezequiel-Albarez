...
public class GeneroController {
	...
	public ResponseEntity<?> saveGenero(@RequestBody GeneroDto generoDto){
		GeneroDtoInfo nuevoGenero=generoService.saveGenero(generoDto);
	...
	@PutMapping("/{id}")
	public ResponseEntity<?> updatePeliculaSerie(@PathVariable(value = "id") int id,@RequestBody GeneroDto generoDto){
